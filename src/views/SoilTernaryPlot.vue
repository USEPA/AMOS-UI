<template>
  ...
  <ul>
    <li><b>Sand:</b> 0.05mm-2.0mm in diameter</li>
    <li><b>Silt:</b> 0.002-0.05mm in diameter</li>
    <li><b>Clay:</b> <0.002mm in diameter</li>
  </ul>
  <div id="soil-ternary-container"></div>
</template>
  ...
  export default {
    ...
    mounted() {
      ...
      function createSoilTernaryPlot() {
        ...
        const width = 600;
        const height = 600;
        const margin = { top: 36, right: 46, bottom: 20, left: 40 };
