...
<template>
  ...
  <div style="padding: 10px;">
    ...
    <div style="color: darkred;" v-if="errors.no_project_name"><strong>Error:</strong> This field is required.</div>
  </div>
  <BAccordion free>
    ...
    <BAccordionItem title="Data Filtering" visible>
      <table class="nostripe job-submission-input-table">
        <tr>
          <th>
    ...
    <BAccordionItem title="Adducts" visible>
      <table class="nostripe job-submission-input-table">
        <tr>
          <th>
    ...
    <BAccordionItem title="Tracers" visible>
      <table class="nostripe job-submission-input-table">
        <tr>
          <th>
    ...
    <BAccordionItem title="Database Searching" visible>
      <table class="nostripe job-submission-input-table">
        <tr>
          <th>
  ...
  <BAlert variant="danger" v-model="errors.any">
    There are errors with your submission.  Please check above -- sections with errors will have their titles in red, and specific fields with errors will have red error messages with them.
  </BAlert>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      resetSettings() {
        ...
        this.neg_adducts = ["Cl", "Br", "HCO2", "CH3CO2", "CF3CO2"]
