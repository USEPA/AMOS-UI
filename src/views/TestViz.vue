<template>
  <BProgress striped :animated="animated" :value="val" />
  <button @click="val = val + 5">Toggle</button>
  <br />
  <!-- <div>
    <ag-grid-vue
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.autoGroupColumnDef = { filter: 'agTextColumnFilter', filterValueGetter: params => params.data.country.split("").reverse().join("")}
    }
  }
</script>