...
const routes = [
  ...
  {path: "/view_method/:internal_id", name: "Method Viewer", component: ()=>import('/src/views/MethodViewer.vue')},
  {path: "/view_fact_sheet/:internal_id", name: "Fact Sheet Viewer", component: ()=>import('/src/views/FactSheetViewer.vue')},
