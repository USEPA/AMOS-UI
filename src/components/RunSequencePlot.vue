<!--
  This plot visualizes data across runs in a sequence from an INTERPRET NTA job.

  This component takes one prop:
  - workbook: An object representing the results workbook, generated by the XLSX library.  Required.
-->
