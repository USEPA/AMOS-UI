<!--
  This is a display of data from an INTERPRET NTA job.  It plots and allows exploring of detection information on a
  per-sample basis.

  This component takes one prop:
  - workbook: A workbook object generated by the XLSX library.

  NOTE: This component will require modifications in the near future, as JavaScript fails to read larger workbooks that
  can be produced by NTA jobs.
-->
