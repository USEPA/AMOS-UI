<!--
  ...
  Note that this code is a minimally-modified version of code I grabbed -- it's not fully functional as of 2025-05-13,
  and the intent was to essentially disassemble and rebuild the code into something that worked better with Vue (see the
  file NTAMetadataVisualizationNew.vue for the incomplete rebuild of the code.)

  Original code was grabbed from https://github.com/shajarizwan/tripod_vis.
-->

<template>
  <div>

    <div id = "tripod-main-container">
      <div class="tripod-title" id="tripod-title"></div>
      <div class="tripod-title-static" id="tripod-title-static"></div>
      <div class="tripod-i" id="tripod-i"></div>
      <div id="tripod-chart-container" style="padding-right: 40px;">
        <div id="tripod-shuttle-buttons"  ></div>
        <div class="tripod-chart" id="tripod-chart-MS2"  ></div>
    ...
    <div id = "tripod-settings-container">
      <div class="metadata-legend" id="metadata-legend" style="width: 276px;"></div>
      <div class="tripod-infobox" id="tripod-infobox" style="width: 367px; height: 304px;"></div>
...
<script>
  ...
  import '@/styles/nta_metadata_visualization.css'
  ...
  export default {
    ...
    mounted() {
      ...
      function getTop5Rows(arr, categoryField, valueField) {
        ...
        return cleanData(result, usefulKeys)
      }
      ...
      async function generatePlots(filePath) {
        ...
        // functions needed in a bunch of places
        var showBarsMetadata, showBarsHazard, showBarsMS2
      ...
      let infoboxHeight, infoboxTop, spanTop, settingsHeight, buttonTop, gradientTop
      ...
      let outlinkDiv, meta_bars, hazard_bars, MS2_bars
      function addInfoBox() {
        ...
        const infoBox = makeSvgElement(355, 304, "infobox", d3.select("#tripod-infobox"))
        ...
        let more_features_span = document.createElement('span')
        ...
        let more_features = document.createTextNode("")
      ...
      function makeArrows(){
        const arrowsvgleft = makeSvgElement(30, 30, 'tripod-arrow-left', d3.select("#tripod-chart-container"));
          ...
          document.getElementById('left-arrow').addEventListener('click', function(event) {goToPosition(event, "back")});
        ...
        const arrowsvgright = makeSvgElement(30, 30, 'tripod-arrow-right', d3.select("#tripod-chart-container"));
          ...
          document.getElementById('right-arrow').addEventListener('click', function(event) {goToPosition(event, "forward")});
          ...
          const arrowsvglast = makeSvgElement(30, 30, 'tripod-arrow-last', d3.select("#tripod-chart-container"));
            ...
            document.getElementById('last-arrow').addEventListener('click', function(event) {goToPosition(event, "last")});
          ...
          const arrowsvgfirst = makeSvgElement(30, 30, 'tripod-arrow-first', d3.select("#tripod-chart-container"));
            ...
            document.getElementById('first-arrow').addEventListener('click', function(event) {goToPosition(event, "first")});
          ...
          let button = document.createElement('button')
            ...
            button.addEventListener('click', function(event) {goToPosition(event, "input")})
        }
      ...
      if (hasMS2) {
        xMS2 = addXaxis(1, 136)
        xMeta = addXaxis(4, 259)
        xHazard = addXaxis(12, 384)
      }
      else {
      ...
      function yAxisHazard(data){
        ...
        let ylabelHazard = svgHazard.append("g")
          .attr("transform", `translate(135, 20)`)
      ...
      let legendText = ["PubMed Articles", "PubChem Articles", "PubChem Patents", "PubChem Sources"]
      ...
      function createInfoTooltip(){
        let tooltipInfo = d3.select("#tripod-i")
          .append("div")
          .style("display", "none")
          .attr("class", "tooltip")
          .style("background-color", "white")
        ...
        const infosvg = makeSvgElement(64, 20, 'tripod-info', d3.select("#tripod-i"));  
          let backgroundCircle = infosvg.append('circle')
          ...
          let infoCircle = infosvg.append('path')
